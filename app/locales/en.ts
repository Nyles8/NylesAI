...
>>>>>>> upstream/main
  ...
  Store: {
    ...
    BotHello:
      "Hello, welcome to Nyles AI! \nWhat can I do for you today?  For understanding the questioning skills, please enter: prompt project \ n \ n Click the robot icon below to change the model",
